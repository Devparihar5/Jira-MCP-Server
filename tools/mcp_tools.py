"""
Proper MCP Tools for Jira Server
Using explicit tool registration with schemas
"""
...
async def handle_get_issue(jira_service: JiraService, arguments: Dict[str, Any]) -> List[TextContent]:
...
async def handle_search_issues(jira_service: JiraService, arguments: Dict[str, Any]) -> List[TextContent]:
...
async def handle_create_issue(jira_service: JiraService, arguments: Dict[str, Any]) -> List[TextContent]:
...
async def handle_add_comment(jira_service: JiraService, arguments: Dict[str, Any]) -> List[TextContent]:
...
async def handle_add_worklog(jira_service: JiraService, arguments: Dict[str, Any]) -> List[TextContent]:
...
def register_mcp_tools(server: Server, jira_service: JiraService):
    """Register all MCP tools with explicit definitions."""
    ...
    @server.call_tool()
    async def call_tool_handler(name: str, arguments: Dict[str, Any]) -> Sequence[TextContent]:
